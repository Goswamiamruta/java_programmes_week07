 ...
 * with name width and height of type double. The class needs to have two constructors.
 ...
 * less than 0 it needs to set the height field value to 0. Write the following methods (instance methods):
 ...
 * Wall wall = new Wall (5, 4); //System.out.println("area= " + wall.getArea()); wall.setHeight(-1.5);
 * System.out.println("width= " + wall.getWidth()); System.out.println("height= " + wall.getHeight());
 * System.out.println("area= " + wall.getArea()); → OUTPUT: area= 20.0 width= 5.0 height= 0.0 area= 0.0
