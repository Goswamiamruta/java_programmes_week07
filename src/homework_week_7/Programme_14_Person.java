 ...
 * String and age of type int. Write the following methods (instance methods):
 * *Method named getFirstName without any parameters, it needs to return
 * the value of the firstName field. *Method named getLastName without
 * any parameters, it needs to return the value of the lastName field.
 ...
 * //person// Person = new Person(); //person.setFirstName(""); // firstName is set to empty string person.
 * setLastName(""); // lastName is set to empty string person.setAge(10);
 ...
 * NOTE: All methods should be defined as public NOT public static. NOTE: In total,
 * you have to write 8 methods.
 */
